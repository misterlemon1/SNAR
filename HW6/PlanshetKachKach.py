...
acc = load_csv("Kacheli/2026-05-28_21-22-17.484_Active 10 Pro/accelerometer_1.csv")
gyr = load_csv("Kacheli/2026-05-28_21-22-17.484_Active 10 Pro/gyroscope_2.csv")
prs = load_csv("Kacheli/2026-05-28_21-22-17.484_Active 10 Pro/pressure_8.csv")
...
plt.tight_layout()
plt.savefig("Kacheli/imu_analysis.png", dpi=150, bbox_inches='tight')
plt.close()
