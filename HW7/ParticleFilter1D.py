...
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(10, 7), facecolor="#0f1117")
fig.suptitle("Particle Filter — 1D отслеживание", color="white", fontsize=13)
for ax in (ax1, ax2):
...
plt.tight_layout()
plt.savefig("pf_1D.png", dpi=130, facecolor="#0f1117", bbox_inches="tight")
plt.show()