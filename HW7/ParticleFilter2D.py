...
MODE     = "linear"  # "linear" или "curved" Влияет только на режим работы
N        = 200
STEPS    = 80
...
fig.suptitle(f"Particle Filter 2D — режим: {MODE}", color="white", fontsize=13)
...
ax1.legend(fontsize=9, facecolor="#1a1d2a", edgecolor="#1e2130", labelcolor="white")
...
ax2.legend(fontsize=9, facecolor="#1a1d2a", edgecolor="#1e2130", labelcolor="white")
ax2.set_facecolor("#0f1117")

plt.tight_layout()
plt.savefig(f"pf_2d_{MODE}.png", dpi=130, facecolor="#0f1117", bbox_inches="tight")
plt.show()