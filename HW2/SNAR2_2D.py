...
Nx=10 #Длина мира
Ny=10 #Ширина мира
wdet=[["g","r","g"],["r","g","r"],["g","g","g"]]#Определитель мира(Повторяющийся паттерн из последовательностей "g","r" или если пусто, то рандом)
...
sensePerMove=100 #Сканов за одно перемещение
